...
export const rendez_vous = pgTable(
  "rendez_vous",
  {
    ...
    heure_fin: varchar("heure_fin", { length: 16 }),
    statut: rendez_vous_statut_enum("statut").notNull(),
    type_creneau: varchar("type_creneau", { length: 64 }),
    patient_label: varchar("patient_label", { length: 255 }),
    patient_initials: varchar("patient_initials", { length: 16 }),
...
export const examen_consultation = pgTable(
  "examen_consultation",
  {
    ...
    poids: numeric("poids"),
    tension_arterielle: varchar("tension_arterielle", { length: 32 }),
    frequence_cardiaque: integer("frequence_cardiaque"),
