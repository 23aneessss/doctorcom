...
export class DocumentRecommendationRepository {
  ...
  async getDoctorProfile(
    ...
    const [doc] = await database
      .select({ nom: utilisateurs.nom, prenom: utilisateurs.prenom, specialite: utilisateurs.specialite, adresse: utilisateurs.adresse, telephone: utilisateurs.telephone })
      .from(utilisateurs)
...
export const documentRecommendationRepository =
  new DocumentRecommendationRepository();
